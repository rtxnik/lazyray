...
* [lzr config backup](lzr_config_backup.md)	 - Backup configuration to an encrypted archive
...
* [lzr config restore](lzr_config_restore.md)	 - Restore configuration from a backup archive
